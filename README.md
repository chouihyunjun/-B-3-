...
MUSIC_DATABASE = {
    ...
    "우울": [
        ...
        {"title": "[Playlist] 요즘 힘들었던 당신을 ‘위로’해줄 노래✨│어반자카파, 선우정아, 아이유, 권진아, 이하이", "url": "https://youtu.be/4e1YnHauXCU?si=G07xw_RAtNuhgzeu"}
    ],
    "설렘": [
        {"title": "𝐏𝐥𝐚𝐲𝐥𝐢𝐬𝐭 | 듣자마자 설레는 달달한 사랑 노래 플레이 리스트❤️", "url": "https://youtu.be/cePhzednLig?si=2GjWHec4DNyfU2X_"},
        {"title": "[𝐩𝐥𝐚𝐲𝐥𝐢𝐬𝐭] 도입부만 들어도 설레는 사랑노래❤️", "url": "https://youtu.be/jC_IOd-ZjnE?si=akuOeH7OiirZWbIW"}
    ]
}

# 3. AI 감정 분석 함수 (오직 감정 '단어' 하나만 뽑아내도록 지시)
...
# 4. 실행 루프
# ──────────────────────────────────────────────────────────
print("\n🎵 감정에 어울리는 플레이리스트를 매칭해주는 스마트 무드플레이리스트 시작!")
